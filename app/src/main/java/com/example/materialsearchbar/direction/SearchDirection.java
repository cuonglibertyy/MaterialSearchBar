package com.example.materialsearchbar.direction;

import android.os.AsyncTask;

import com.example.materialsearchbar.SearchDirectionListener;
import com.example.materialsearchbar.model.Distance;
import com.example.materialsearchbar.model.Duration;
...
public class SearchDirection {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyA9rTnxqBiap6yioOqcGREcyrcZno2ShGU";
    ...
    private void parseJSon(String data) throws JSONException {
        ...
        List<Route> mapRoutes = new ArrayList<Route>();
        JSONObject jsonData = new JSONObject(data);
        JSONArray jsonRoutes = jsonData.getJSONArray("routes");
        for (int i = 0; i < jsonRoutes.length(); i++) {
            JSONObject jsonRoute = jsonRoutes.getJSONObject(i);
            Route mapRoute = new Route();
            ...
            mapRoute.mapDistance = new Distance(jsonDistance.getString("text"), jsonDistance.getInt("value"));
            mapRoute.mapDuration = new Duration(jsonDuration.getString("text"), jsonDuration.getInt("value"));
